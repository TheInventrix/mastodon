...
const messages = defineMessages({
  ...
  public_short: { id: 'privacy.local.short', defaultMessage: 'Local' },
  public_long: { id: 'privacy.local.long', defaultMessage: 'Post to local public timeline' },
...
class PrivacyDropdown extends React.PureComponent {
  ...
  render () {
    ...
    const options = [
      ...
      { icon: 'users', value: 'local', shortText: intl.formatMessage(messages.public_short), longText: intl.formatMessage(messages.public_long) },
